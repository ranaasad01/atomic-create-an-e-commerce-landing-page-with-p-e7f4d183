          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="relative w-full aspect-square max-w-[520px] ml-auto">
                {/* Main image */}
                <div className="absolute inset-0 rounded-3xl overflow-hidden shadow-[0_8px_32px_rgba(0,0,0,0.12)]" style={{ fontSize: "20px", color: "#1872f2" }}>
                  <img
          ...
          >
            {testimonials.map((t, i) => (
              ...
              >
                ...
                <p className="text-sm text-slate-700 leading-relaxed flex-1" style={{ color: "#030d1c" }}>
                  &ldquo;{t.text}&rdquo;
                </p>
